<?php
namespace Drd\Tests\DiceRolls\Templates\Rolls;
...
use Drd\DiceRolls\Templates\Rollers\Roller1d4;
...
class Roll2d6DrdPlusTest extends TestWithMockery
{
     ...
     * @expectedException \Drd\DiceRolls\Templates\Rolls\Exceptions\UnexpectedDice
    ...
    /**
     * @test
     * @expectedException \Drd\DiceRolls\Templates\Rolls\Exceptions\UnexpectedNumberOfDiceRolls
     */
    ...
    /**
     * @test
     * @expectedException \Drd\DiceRolls\Templates\Rolls\Exceptions\UnexpectedBonus
     */
    ...
    /**
     * @test
     * @expectedException \Drd\DiceRolls\Templates\Rolls\Exceptions\MissingBonusDiceRoll
     */
    ...
    /**
     * @test
     * @expectedException \Drd\DiceRolls\Templates\Rolls\Exceptions\UnexpectedMalus
     */
    ...
    /**
     * @test
     * @expectedException \Drd\DiceRolls\Templates\Rolls\Exceptions\MissingMalusDiceRoll
     */
